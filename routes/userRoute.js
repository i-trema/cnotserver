...
router.get("/privacy", async (req, res) => {
  try {
    res.send(
      <p>
        C.No.T! Privacy Policy <br />
        Posted: October 24, 2022 <br />
        ianis m <br />
        <br />
        Thanks for using C.No.T! Here we describe how we collect, use and handle
        your information when you use our application. <br />
        <br />
        What & Why We <br />
        collect email, username and password that you enter in the "Signup" page
        (authentification/inscription) to create a user account and find your
        Notes. We collect these informations and your Notes to store it in a
        private online database. <br />
        <br />
        With whom <br />
        Your user account and your Notes are stored in a MongoDB database.
        Password is crypted in the database so we can't know it. <br />
        <br />
        Retention. <br />
        ...
        with our legal obligations, resolve disputes, or enforce our agreements.{" "}
        <br />
        <br />
        Where
        <br />
        ...
        our assets, your information may be transferred as part of that deal. We
        will notify you (for example, via a message to the email address
        associated with your account) of any such deal and outline your choices
        in that event. We may revise this Privacy Policy from time to time, and
        will post the most current version on our website. If a revision
        meaningfully reduces your rights, we will notify you. <br />
        <br />
        Contact
        <br />
        Have questions or concerns about "C.No.T!" ? Contact us at imtest94dev
